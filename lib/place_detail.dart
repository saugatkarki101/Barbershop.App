                              ...
                              if (widget.photo_reference != '')
                                Container(
                                    ...
                                    child: ClipRRect(
                                        ...
                                        child: Image.network(
                                            "https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photo_reference=${widget.photo_reference}&key=*insert apiKey here*",
                                            fit: BoxFit.cover))),
                            ],
                          ))),
                ),
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return Padding(
                          ...
                          child: ClipRRect(
                              ...
                              child: Image.network(
                                "https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photo_reference=${widget.photos[index]}&key=*insert apiKey here*",
                                fit: BoxFit.cover,
                                //centerSlice: Rect.,
                              )),
                          // onTap: () =>
